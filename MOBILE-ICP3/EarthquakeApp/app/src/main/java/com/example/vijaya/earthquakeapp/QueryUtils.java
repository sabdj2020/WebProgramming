            ...
            */
            ...
            try {
                ...
                for (int i = 0; i < val.length(); i++) {
                    object1 = new JSONObject(val.getString(i));
                    object2 = new JSONObject(object1.getString("properties"));
                    Earthquake e = new Earthquake(Double.parseDouble(object2.getString("mag")), object2.getString("place"), Long.parseLong(object2.getString("time")), object2.getString("url"));
                    earthquakes.add(e);
                    Log.d("App", object2.getString("mag"));
                }
